...
const double AUDIO_SAMPLE_RATE = SAMPLE_RATE_DEF;
#define APU_RING_BUFFER_SIZE 10000
const double APU_STEPS_PER_SAMPLE = CPU_FREQUENCY_DEF / AUDIO_SAMPLE_RATE;
const double APU_STEPS_PER_FRAME_COUNTER_STEP = CPU_FREQUENCY_DEF / 240.0;
