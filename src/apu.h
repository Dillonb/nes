...
static const double APU_STEPS_PER_SAMPLE = CPU_FREQUENCY_DEF / AUDIO_SAMPLE_RATE;
static const double APU_STEPS_PER_FRAME_COUNTER_STEP = CPU_FREQUENCY_DEF / 240.0;
